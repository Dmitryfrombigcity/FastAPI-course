...
from _4_3_3.api.endpoints.auth.authentication import decode_jwt
from _4_3_3.api.endpoints.auth.validation import validate_password
from _4_3_3.schemas import User, UserSchema
from _4_3_3.users import users_db, refresh_tokens
...
async def authenticate_user(user: User) -> None:
